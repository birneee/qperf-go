...
// mostly copied from quic-go/qlog/frame.go
...
func marshalPingFrame(enc *gojay.Encoder, _ *logging.PingFrame) {
	enc.StringKey("frame_type", "ping")
}

type ackRanges []logging.AckRange
...
type ackRange logging.AckRange
