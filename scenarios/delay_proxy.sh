...
sudo ip netns exec ns-client-side-proxy $QPERF_BIN proxy --tls-cert ../proxy.crt --tls-key ../proxy.key --server-facing-max-receive-window $RECEIVE_WINDOW --log-prefix "client_side_proxy" --qlog-prefix "client_side_proxy" $QLOG &
PROXY_PID=$!
